/* test Trainer for RL Competition
...
*
* NOTE: This program has been slightly modified by Pedro Mediano for use in the helicopterRL project in Imperial College London. More information in https://github.com/pmediano/helicopterRL .
*
*/
...
public class testTrainer {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		testTrainerHelper.loadHelicopter(whichTrainingMDP);	

		int episodeCount = 200; //number of episodes to run
